...
const displayTabContent = () =>{
    switch(activeTab){
        ...
        case 'About':
            return <JobAbout info={data[0].job_description?? "No Data Prodoved"}/>
...
const JobDetails =()=>
{
    ...
    return (
        <SafeAreaView style={{flex:1, backgroundColor: COLORS.lightWhite}}>
            <Stack.Navigator screenOptions={{headerStyle:{backgroundColor: COLORS.lightWhite}, headerShadowVisible: false, headerBackVisible: false,
        headerLeft: ()=>(
